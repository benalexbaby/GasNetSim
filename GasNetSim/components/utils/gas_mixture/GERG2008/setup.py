...
#    Last change on 1/18/22, 1:01 PM
...
MaxTrmP = 24
epsilon = 1e-15
coik = np.zeros((MaxFlds + 1, MaxTrmP + 1))
doik = np.zeros((MaxFlds + 1, MaxTrmP + 1))
dijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
Drold = 0
Trold = 0
Told = 0
Trold2 = 0
xold = np.zeros(MaxFlds + 1)
mNumb = np.zeros((MaxFlds + 1, MaxFlds + 1))
kpol = np.zeros(MaxFlds + 1)
kexp = np.zeros(MaxFlds + 1)
kpolij = np.zeros(MaxMdl + 1)
kexpij = np.zeros(MaxMdl + 1)
Dc = np.zeros(MaxFlds + 1)
Tc = np.zeros(MaxFlds + 1)
MMiGERG = np.zeros(MaxFlds + 1)
Vc3 = np.zeros(MaxFlds + 1)
Tc2 = np.zeros(MaxFlds + 1)
noik = np.zeros((MaxFlds + 1, MaxTrmP + 1))
toik = np.zeros((MaxFlds + 1, MaxTrmP + 1))
cijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
eijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
gijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
nijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
tijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
btij = np.zeros((MaxFlds + 1, MaxFlds + 1))
bvij = np.zeros((MaxFlds + 1, MaxFlds + 1))
gtij = np.zeros((MaxFlds + 1, MaxFlds + 1))
gvij = np.zeros((MaxFlds + 1, MaxFlds + 1))
fij = np.zeros((MaxFlds + 1, MaxFlds + 1))
th0i = np.zeros((MaxFlds + 1, 7 + 1))
n0i = np.zeros((MaxFlds + 1, 7 + 1))
taup = np.zeros((MaxFlds + 1, MaxTrmP + 1))
taupijk = np.zeros((MaxFlds + 1, MaxTrmM + 1))
...
bijk = np.zeros((MaxMdl + 1, MaxTrmM + 1))
T0 = 0
d0 = 0
...
gtij[6][7] = 1.001432824
# i-C4H10-i-C5H1
bvij[6][8] = 1
gvij[6][8] = 1.002284353
btij[6][8] = 1
gtij[6][8] = 1.001835788
# i-C4H10-C5H12
bvij[6][9] = 1
gvij[6][9] = 1.002779804
btij[6][9] = 1
gtij[6][9] = 1.002495889
# i - C4H10 - C6H14
bvij[6][10] = 1
gvij[6][10] = 1.010493989
btij[6][10] = 1
gtij[6][10] = 1.006018054
# i-C4H10-C7H16
bvij[6][11] = 1
gvij[6][11] = 1.021668316
btij[6][11] = 1
gtij[6][11] = 1.00988576
# i-C4H10-C8H18
bvij[6][12] = 1
gvij[6][12] = 1.032807063
btij[6][12] = 1
gtij[6][12] = 1.013945424
# i-C4H10-C9H20
bvij[6][13] = 1
gvij[6][13] = 1.047298475
btij[6][13] = 1
gtij[6][13] = 1.017817492
# i-C4H10-C10H22
bvij[6][14] = 1
gvij[6][14] = 1.060243344
btij[6][14] = 1
gtij[6][14] = 1.021624748
# i-C4H10-H2
bvij[6][15] = 1
...
btij[7][21] = 1
gtij[7][21] = 1.245039498
# C5H12-i-C5H12
bvij[8][9] = 1
gvij[8][9] = 1.000024335
btij[8][9] = 1
gtij[8][9] = 1.000050537
# i-C5H12-C6H14
bvij[8][10] = 1
gvij[8][10] = 1.002995876
btij[8][10] = 1
gtij[8][10] = 1.001204174
# i-C5H12-C7H16
bvij[8][11] = 1
gvij[8][11] = 1.009928206
btij[8][11] = 1
gtij[8][11] = 1.003194615
# i-C5H12-C8H18
bvij[8][12] = 1
gvij[8][12] = 1.017880545
btij[8][12] = 1
gtij[8][12] = 1.00564748
# i-C5H12-C9H20
bvij[8][13] = 1
gvij[8][13] = 1.028994325
btij[8][13] = 1
gtij[8][13] = 1.008191499
# i-C5H12-C10H22
bvij[8][14] = 1
gvij[8][14] = 1.039372957
btij[8][14] = 1
gtij[8][14] = 1.010825138
# i-C5H12-H2
bvij[8][15] = 1
...
btij[9][10] = 1
gtij[9][10] = 1.000761237
# C5H12-C7H16
bvij[9][11] = 1
gvij[9][11] = 1.008972412
btij[9][11] = 1
gtij[9][11] = 1.002441051
# C5H12-C8H18
bvij[9][12] = 1
gvij[9][12] = 1.069223964
btij[9][12] = 1
gtij[9][12] = 1.016422347
# C5H12-C9H20
bvij[9][13] = 1
gvij[9][13] = 1.034910633
btij[9][13] = 1
gtij[9][13] = 1.103421755
# C5H12-C10H22
bvij[9][14] = 1
gvij[9][14] = 1.016370338
btij[9][14] = 1
gtij[9][14] = 1.049035838
# C5H12-H2
bvij[9][15] = 1
...
btij[11][12] = 1
gtij[11][12] = 0.998793111

# C7H16-C9H20
bvij[11][13] = 1
gvij[11][13] = 1.001370076
btij[11][13] = 1
gtij[11][13] = 1.001150096

# C7H16-C10H22
bvij[11][14] = 1
gvij[11][14] = 1.002972346
btij[11][14] = 1
gtij[11][14] = 1.002229938
...
btij[12][13] = 1
gtij[12][13] = 1.000235044

# C8H18-C10H22
bvij[12][14] = 1
gvij[12][14] = 1.002553544
btij[12][14] = 1
gtij[12][14] = 1.007186267
...
btij[12][17] = 1
gtij[12][17] = 1.276565536

# C8H18-H2O
bvij[12][18] = 1
gvij[12][18] = 0.599484191
btij[12][18] = 1
gtij[12][18] = 0.662072469
...
btij[17][21] = 1
gtij[17][21] = 0.954215746

# H2O-H2S
bvij[18][19] = 1
gvij[18][19] = 1.014832832
btij[18][19] = 1
gtij[18][19] = 0.940587083
...
# This is not called in the current code, but included below to show how the values were calculated.
# The return above can be removed to call this code.
